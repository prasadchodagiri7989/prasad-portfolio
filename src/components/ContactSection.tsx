...
const ContactSection = () => {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    emailjs.sendForm(
      'service_3wub0eq',     // Replace with your actual Service ID
      'template_y4gwimy',    // Replace with your actual Template ID
      formRef.current,
      'OkOnE7M4fIg7vzrAF'      // Replace with your actual Public Key
    )
    .then(() => {
